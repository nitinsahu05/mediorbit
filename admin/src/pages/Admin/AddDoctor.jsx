      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        <div className='flex items-center gap-4 mb-4 text-gray-500'>
          <img
            ...
            src={imageUrl.trim() ? imageUrl.trim() : assets.upload_area}
            alt=""
        ...
        <div className='mb-6'>
          <p className='text-sm text-gray-600 mb-1'>Image URL <span className='text-red-400'>*</span></p>
          <input
            onChange={e => setImageUrl(e.target.value)}
            value={imageUrl}
            className='border rounded px-3 py-2 w-full focus:outline-none focus:border-primary'
            type='url'
