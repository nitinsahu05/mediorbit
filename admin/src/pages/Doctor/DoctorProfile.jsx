...
const DoctorProfile = () => {
    ...
    if (!profileData) {
        return (
            <div className='m-5'>
                <p className='text-gray-600'>Failed to load profile data. Please refresh the page or log in again.</p>
            </div>
        )
    }
    ...
    return (
        <div>
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img className='bg-primary/80 w-full sm:max-w-64 rounded-lg' src={imagePreview || profileData.image} alt="" />
                    {isEdit && (
                        <div className='mt-4'>
